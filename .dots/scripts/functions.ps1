...
try {
    function Get-UsableFunctions {
        ...
        .DESCRIPTION
        The Get-UsableFunctions function allows you to list, filter, and view
        the source code of functions available in your PowerShell session.
        You can use wildcards to filter functions by name and optionally view
        the source code of a specific function.
